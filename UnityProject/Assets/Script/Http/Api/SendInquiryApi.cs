...
namespace Http {
    ...
    public class SendInquiryApi
    {
        ...
        #region Construct
        public SendInquiryApi (string inquiry) 
        {
            //Ready Proccesing
            _success = false;
            ...
            postDatas.Add (HttpConstants.INQUIRY, inquiry);
        ...
        {
            string url = DomainData.GetApiUrl(DomainData.SEND_INQUIRY);
