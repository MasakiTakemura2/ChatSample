...
/// GameObjectに付いている前提
/// </summary>
public class PrivachyWebView : SingletonMonoBehaviour<PrivachyWebView>
{
    ...
    void OnEnable () 
    {
        string url= DomainData.GetWebviewDataURL(DomainData.WEBVIEW_PRIVACY)+ "?user_key=" + AppStartLoadBalanceManager._userKey;
		Debug.Log (url + " terms webview url " + System.DateTime.Now.ToString ());
