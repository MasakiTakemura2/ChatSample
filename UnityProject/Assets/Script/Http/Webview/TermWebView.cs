...
/// GameObjectに付いている前提
/// </summary>
public class TermWebView : SingletonMonoBehaviour<TermWebView>
{
    ...
    void OnEnable () 
    {
        string url= DomainData.GetWebviewDataURL(DomainData.WEBVIEW_TERMS) + "?user_key=" + AppStartLoadBalanceManager._userKey;
